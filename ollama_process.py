...
def ollama_process(file_content, model, requirements):
    ...
    prompt = f"""Проанализируй предоставленный код на потенциальные уязвимости безопасности, включая:
        ...
        ВАЖНО: Верни только исправленную версию полного кода без каких-либо комментариев, объяснений или дополнительного текста. Исходная структура и функциональность кода должны быть сохранены. Если код соответствует требованиям, просто продублируй его в ответе.
